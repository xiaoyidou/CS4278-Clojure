...
(deftest restaurant-test
  (testing "Get the name of the first restaurant in the db"
    (is (= "McDonalds" (first-restaurant db)))))
...
(deftest handle-message-test
  (testing "the integration and handling of messages"
    (let [ehdlrs (merge
     ...
     (is (= "McDonalds is now in the database."
            (<!! (handle-message
                  system
                  "xiaoyi"
                  "restaurant,McDonalds,american,1"))))
     (is (= "Urban Cookhouse is now in the database."
            (<!! (handle-message
                  system
                  "xiaoyi"
                  "restaurant,Urban Cookhouse,american,2"))))
     (is (= "Hattie B's Chicken - Midtown is now in the database."
               (<!! (handle-message
                     system
                     "xiaoyi"
                     "restaurant,Hattie B's Chicken - Midtown,american,2"))))
     (is (= "The Row is now in the database."
                 (<!! (handle-message
                       system
                       "xiaoyi"
                       "restaurant,The Row,american,2"))))
     (is (= "Nada is now in the database."
                (<!! (handle-message
                      system
                      "xiaoyi"
                      "restaurant,Nada,mexican,2"))))
     (is (= "Peg Leg Porker is now in the database."
                 (<!! (handle-message
                       system
                       "xiaoyi"
     ...
     (is (= "Hattie B's Chicken - Midtown is now in the database."
                (<!! (handle-message
                      ...
                      "xiaoyi"
                      "restaurant,Hattie B's Chicken - Midtown,american,2"))))
     (is (= "Biscuit Love: Gulch is now in the database."
                 (<!! (handle-message
                       system
                       "xiaoyi"
                       "restaurant,Biscuit Love: Gulch,southern,2"))))
     (is (= "The Stillery is now in the database."
                  (<!! (handle-message
                        system
                        "xiaoyi"
                        "restaurant,The Stillery,american,2"))))
     (is (= "Soy Bistro is now in the database."
                 (<!! (handle-message
                       system
                       "xiaoyi"
                       "restaurant,Soy Bistro,korean,2"))))
     (is (= "Corner Asian Bistro is now in the database."
                  (<!! (handle-message
                        system
                        "xiaoyi"
                        "restaurant,Corner Asian Bistro,chinese,2"))))
     (is (= "Here are your option(s): Corner Asian Bistro."
            (<!! (handle-message
                  system
                  "xiaoyi"
                  "choose,cuisine,chinese"))))
     (is (= "Here are your option(s): McDonalds."
           (<!! (handle-message
                 system
                 "xiaoyi"
                 "choose,price,1")))))))
